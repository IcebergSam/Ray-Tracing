...
class cameraMatrix:
    ...
    def minimumIntersection(self,direction,objectList):
        ...
        Input: direction is the vector describing the direction of the ray;
            objectList is a list of objects composing the scene.
        Output: Returns a list of tuples (k,t0) where
            k is the position in the list of an object that the ray intersects, and
            t0 is the minimum t-value of the intersection the ray makes with the object.
        This list is sorted in increasing order of the tvalues.

        Algorithm: • create empty intersection list
            • for each object k in the list:
                ...
                ◦ transform the ray with M−1 in the following way:
                  Te=M−1e , where
                    e is the position of the camera, and
                  Td=M−1d , where
                    d is the direction of the ray
                ◦ t0= object.intersection (Te,Td)
                ◦ if t0≠−1.0 then add tuple (k,t0) to intersection list
            • sort intersection list in increasing order of t0
